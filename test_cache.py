...
from main import MediaLibraryLinker
...
def test_build_cache_function(setup_test_environment, monkeypatch):
    # 模拟内部函数的行为
    ...
    # 使用monkeypatch替换内部函数
    monkeypatch.setattr(MediaLibraryLinker, "build_cache", mock_rebuild_data)
